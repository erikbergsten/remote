...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__1049){
var map__1050 = p__1049;
var map__1050__$1 = (((((!((map__1050 == null))))?(((((map__1050.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1050.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__1050):map__1050);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1050__$1,cljs.core.cst$kw$on_DASH_write);
...
(jsprops.onChange = (function (p1__1052_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__1052_SHARP_);
}));
