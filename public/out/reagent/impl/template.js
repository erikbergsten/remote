...
var G__1057 = o;
goog.object.set(G__1057,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__1058__delegate = function (args){
...
while (G__1059__i < G__1059__a.length) {G__1059__a[G__1059__i] = arguments[G__1059__i + 0]; ++G__1059__i;}
  args = new cljs.core.IndexedSeq(G__1059__a,0,null);
} 
return G__1058__delegate.call(this,args);};
G__1058.cljs$lang$maxFixedArity = 0;
G__1058.cljs$lang$applyTo = (function (arglist__1060){
var args = cljs.core.seq(arglist__1060);
return G__1058__delegate(args);
});
...
var G__1061 = o;
goog.object.set(G__1061,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__1062__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__1062 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__1063__i = 0, G__1063__a = new Array(arguments.length -  0);
while (G__1063__i < G__1063__a.length) {G__1063__a[G__1063__i] = arguments[G__1063__i + 0]; ++G__1063__i;}
  args = new cljs.core.IndexedSeq(G__1063__a,0,null);
} 
return G__1062__delegate.call(this,args);};
G__1062.cljs$lang$maxFixedArity = 0;
G__1062.cljs$lang$applyTo = (function (arglist__1064){
var args = cljs.core.seq(arglist__1064);
return G__1062__delegate(args);
});
G__1062.cljs$core$IFn$_invoke$arity$variadic = G__1062__delegate;
return G__1062;
})()
;
} else {
...
var G__1065 = props;
var G__1065__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__1065,cljs.core.cst$kw$id,id):G__1065);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__1065__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__1066 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__1066,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__1066;
}
})(),id_class);
...
var G__1067 = (cljs.core.count(argv) - first_child);
switch (G__1067) {
case (0):
...
break;
case (1):
var G__1068 = component;
var G__1069 = jsprops;
var G__1070 = reagent.impl.protocols.as_element(this$,cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__1068,G__1069,G__1070);
...
var vec__1072 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1072,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1072,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1072,(2),null);
...
var temp__5739__auto___1075 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___1075 == null)){
} else {
var key_1076 = temp__5739__auto___1075;
(jsprops.key = key_1076);
}
...
var temp__5739__auto___1079 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___1079 == null)){
} else {
var key_1080 = temp__5739__auto___1079;
(jsprops.key = key_1080);
}

var G__1077 = reagent.impl.component.functional_render_fn(compiler,tag);
var G__1078 = jsprops;
return reagent.impl.template.global$module$react.createElement(G__1077,G__1078);
});
/**
...
var temp__5739__auto___1081 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___1081 == null)){
} else {
var key_1082 = temp__5739__auto___1081;
(jsprops.key = key_1082);
}
...
var temp__5739__auto___1083 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___1083 == null)){
} else {
var key_1084 = temp__5739__auto___1083;
(jsprops.key = key_1084);
}
...
var temp__5739__auto___1085 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___1085 == null)){
} else {
var key_1086 = temp__5739__auto___1085;
(jsprops.key = key_1086);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__1087_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__1087_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__1088 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1088,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1088,(1),null);
...
break;
default:
var G__1093 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__1094 = compiler;
v = G__1093;
compiler = G__1094;
continue;
...
var G__1095 = tag;
var G__1095__$1 = (((G__1095 instanceof cljs.core.Keyword))?G__1095.fqn:null);
switch (G__1095__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template1098 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template1098 = (function (opts,id,fn_to_element,meta1099){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template1098.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_1100,meta1099__$1){
var self__ = this;
var _1100__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template1098(self__.opts,self__.id,self__.fn_to_element,meta1099__$1));
}));

(reagent.impl.template.t_reagent$impl$template1098.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_1100){
var self__ = this;
var _1100__$1 = this;
return self__.meta1099;
}));

(reagent.impl.template.t_reagent$impl$template1098.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template1098.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template1098.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template1098.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template1098.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$opts,cljs.core.cst$sym$id,cljs.core.cst$sym$fn_DASH_to_DASH_element,cljs.core.cst$sym$meta1099], null);
}));

(reagent.impl.template.t_reagent$impl$template1098.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template1098.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template1098");

(reagent.impl.template.t_reagent$impl$template1098.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template1098");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template1098.
 */
reagent.impl.template.__GT_t_reagent$impl$template1098 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template1098(opts__$1,id__$1,fn_to_element__$1,meta1099){
return (new reagent.impl.template.t_reagent$impl$template1098(opts__$1,id__$1,fn_to_element__$1,meta1099));
});

}

return (new reagent.impl.template.t_reagent$impl$template1098(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
