...
var G__1077 = o;
goog.object.set(G__1077,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__1078__delegate = function (args){
...
while (G__1079__i < G__1079__a.length) {G__1079__a[G__1079__i] = arguments[G__1079__i + 0]; ++G__1079__i;}
  args = new cljs.core.IndexedSeq(G__1079__a,0,null);
} 
return G__1078__delegate.call(this,args);};
G__1078.cljs$lang$maxFixedArity = 0;
G__1078.cljs$lang$applyTo = (function (arglist__1080){
var args = cljs.core.seq(arglist__1080);
return G__1078__delegate(args);
});
...
var G__1081 = o;
goog.object.set(G__1081,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__1082__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__1082 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__1083__i = 0, G__1083__a = new Array(arguments.length -  0);
while (G__1083__i < G__1083__a.length) {G__1083__a[G__1083__i] = arguments[G__1083__i + 0]; ++G__1083__i;}
  args = new cljs.core.IndexedSeq(G__1083__a,0,null);
} 
return G__1082__delegate.call(this,args);};
G__1082.cljs$lang$maxFixedArity = 0;
G__1082.cljs$lang$applyTo = (function (arglist__1084){
var args = cljs.core.seq(arglist__1084);
return G__1082__delegate(args);
});
G__1082.cljs$core$IFn$_invoke$arity$variadic = G__1082__delegate;
return G__1082;
})()
;
} else {
...
var G__1085 = props;
var G__1085__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__1085,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__1085);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__1085__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__1086 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__1086,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__1086;
}
})(),id_class);
...
var G__1087 = (cljs.core.count.call(null,argv) - first_child);
switch (G__1087) {
case (0):
...
var vec__1089 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__1089,(0),null);
var id = cljs.core.nth.call(null,vec__1089,(1),null);
var className = cljs.core.nth.call(null,vec__1089,(2),null);
...
var temp__5739__auto___1092 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5739__auto___1092 == null)){
} else {
var key_1093 = temp__5739__auto___1092;
(jsprops.key = key_1093);
}
...
var temp__5739__auto___1094 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5739__auto___1094 == null)){
} else {
var key_1095 = temp__5739__auto___1094;
(jsprops.key = key_1095);
}
...
var temp__5739__auto___1096 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5739__auto___1096 == null)){
} else {
var key_1097 = temp__5739__auto___1096;
(jsprops.key = key_1097);
}
...
var temp__5739__auto___1098 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___1098 == null)){
} else {
var key_1099 = temp__5739__auto___1098;
(jsprops.key = key_1099);
}
...
var temp__5739__auto___1100 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___1100 == null)){
} else {
var key_1101 = temp__5739__auto___1100;
(jsprops.key = key_1101);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__1102_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__1102_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__1103 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__1103,(0),null);
var derefed = cljs.core.nth.call(null,vec__1103,(1),null);
...
break;
default:
var G__1108 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__1109 = compiler;
v = G__1108;
compiler = G__1109;
continue;
...
var G__1110 = tag;
var G__1110__$1 = (((G__1110 instanceof cljs.core.Keyword))?G__1110.fqn:null);
switch (G__1110__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template1113 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template1113 = (function (opts,id,fn_to_element,meta1114){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.meta1114 = meta1114;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template1113.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_1115,meta1114__$1){
var self__ = this;
var _1115__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template1113(self__.opts,self__.id,self__.fn_to_element,meta1114__$1));
}));

(reagent.impl.template.t_reagent$impl$template1113.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_1115){
var self__ = this;
var _1115__$1 = this;
return self__.meta1114;
}));

(reagent.impl.template.t_reagent$impl$template1113.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template1113.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template1113.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template1113.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template1113.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta1114","meta1114",-1501542255,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template1113.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template1113.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template1113");

(reagent.impl.template.t_reagent$impl$template1113.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write.call(null,writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template1113");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template1113.
 */
reagent.impl.template.__GT_t_reagent$impl$template1113 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template1113(opts__$1,id__$1,fn_to_element__$1,meta1114){
return (new reagent.impl.template.t_reagent$impl$template1113(opts__$1,id__$1,fn_to_element__$1,meta1114));
});

}

return (new reagent.impl.template.t_reagent$impl$template1113(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
